...
let queTimer = function (timeVlaue) {
  ...
  // 60 sec is 1000 millisecond ; 274 millisecond is converted to 1 minute 60 sec.
  function Timer() {
    if (timeValue < 10) {
...
function showCssQuestion() {
  ...
  shuffledQuetions = Math.floor(
    Math.random() * (cssQueDB.length - (0 + 1) + 1)
  );
...
function showHtmlQuestion() {
  ...
  shuffledQuetions = Math.floor(
    Math.random() * (htmlQueDB.length - (0 + 1) + 1)
  );
...
function showPythonQuestion() {
  ...
  // for shuffling the questions:
  shuffledQuetions = Math.floor(
    Math.random() * (pythonQueDB.length - (0 + 1) + 1)
  );
  //changing the questions:
