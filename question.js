let cssQueDB = [
    {
      question:
        "Where in an HTML document is the correct place to refer to an external style field?",
  ...
  let htmlQueDB = [
    ...
    {
      question:
        "Which of the following symbols indicates the difference between opening and closing tag of HTML?",
      a: " / ",
      b: " @ ",
      c: " . ",
      d: " ? ",
    ...
    {
      question:
        "Where does the content given inside the TITLE tag appear in the web-page?",
  ...
  let jsQueDB = [
    ...
    {
      question:
        "Which of the following tag is used to link the external JS file in the HTML code?",
      a: "javacript tag",
      b: "script tag",
      c: "scripts tag",
      d: "js tag",
    ...
    {
      question:
        "Which of the following attribute has the link of the external JS file?",
      a: "src",
      b: "href",
      c: "link",
      d: "file",
    ...
    {
      question:
        "Which of the following is used by the getElementByID() method to access the elements?",
    ...
    {
      question:
        "Which of the following methods is used to access the HTML elements by using the class of the element?",
  ...
  let pythonQueDB = [
    ...
    {
      question:
        "What is the correct syntax to output the typy of a variable or object in python?",
      a: "print(tyoeof x)",
      b: "print(typeof(x))",
      c: "print(typeOf(x))",
      d: "print(type(x))",
    ...
    {
      question:
        "Which metgod can be used to remove whitespace from both the beginning and the end of the string?",
      a: "strip()",
      b: "ptrim()",
      c: "trim()",
      d: "len()",
    ...
    {
      question:
        "Which of the folloeing can be used to return a string in uppercase letters?",
      a: "upper()",
      b: "uppercase()",
      c: "toUpperCase()",
      d: "upperCase()",
